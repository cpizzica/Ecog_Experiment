...
%          end
   ...
   methods (Access = protected)
      ...
      function initializeStateMachine(self)
         ...
         showfp = {@draw, self.helpers.stimulusEnsemble,{{'isVisible', true, 1}, {'isVisible', false, []}}, self, 'fixationOn'};
         hidefp = {@draw, self.helpers.stimulusEnsemble,{{'isVisible', false, 1}, {'isVisible', false, []}}, self, 'fixationOff'};
         ...
         stimStates = {...
            ...
            'holdFixation'       {}       chkeyeb  WBSJitter            {}       'showStim'     ; ...
         ...
         responseStates = {...
            'name'               'entry'  'input'  'timeout'            'exit'   'next'         ; ...
            'getChoice'          showi    chkchc   5                    nochc    'waitAfterChoice' ; ...
            'waitAfterChoice'    {}       {}       WATJitter              {}     ''             ; ...
            };
